...
import { BookOpen, FileQuestion, FileText, Briefcase, FileEdit, GraduationCap, Code2, Calculator, ArrowRight, Sparkles } from "lucide-react";
    ...
    <div className="mx-auto max-w-7xl space-y-8">
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {tiles.map((t) => (
            <Link key={t.to} to={t.to} className="group rounded-xl border border-border bg-card p-5 shadow-card-soft transition-all hover:-translate-y-1 hover:shadow-elegant">
